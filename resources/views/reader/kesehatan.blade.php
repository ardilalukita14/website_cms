                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                ...
                                <a href="{{route('reader.show_news',$ksh->id)}}" style="color:black"> 
                                    <div class="banner-img-cap2">
                                        <div class="banner-img">
                                            <img src="{{asset('foto/'.$ksh->foto)}}" alt="" style="width:500px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <a href="{{route('reader.show_news',$tekno->id)}}" style="color:black"> 
                                    <div class="banner-img-cap2">
                                        <div class="banner-cap2 banner-cap3">
                                            <p>TEKNOLOGI</p>
                                            <h3>{{$tekno->judul}}</a></h3>
                                            <p  class="normal">{!!substr($tekno->isi,0,200)!!}...</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <a href="{{route('reader.show_news',$tekno->id)}}" style="color:black"> 
                                    <div class="banner-img-cap2">
                                        <div class="banner-img">
                                            <img src="{{asset('foto/'.$tekno->foto)}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
