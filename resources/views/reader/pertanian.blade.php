                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                ...
                                <a href="{{route('reader.show_news',$pr->id)}}" style="color:black"> 
                                    <div class="banner-img-cap2">
                                        <div class="banner-img">
                                            <img src="{{asset('foto/'.$pr->foto)}}" alt="" style="width:500px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="single-baner-nw2 mb-30">
                                    <div class="banner-img-cap2">
                                        <div class="banner-cap2 banner-cap3">
                                            <p>PERTANIAN</p>
                                           <h3>{{$pr->judul}}</a></h3>
                                            <p class="normal">{{substr($pr->isi,0,200)}}...</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <a href="{{route('reader.show_news',$kr->id)}}" style="color:black"> 
                                    <div class="banner-img-cap2">
                                        <div class="banner-cap2 banner-cap3">
                                            <p>KREATIVITAS</p>
                                            <h3>{{$kr->judul}}</a></h3>
                                            <p  class="normal">{{substr($kr->isi,0,200)}}...</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <a href="{{route('reader.show_news',$kr->id)}}" style="color:black"> 
                                    <div class="banner-img-cap2">
                                        <div class="banner-img">
                                            <img src="{{asset('foto/'.$kr->foto)}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
