      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <!-- <div class="search-element">
            <input class="form-control custom-shadow custom-radius border-0 bg-white col-mb-3" type="search" placeholder="Search" aria-label="Search">
            <button class="btn" type="submit"><i class="ion ion-search" data-feather="search"></i></button>
          </div> -->
        </form>
